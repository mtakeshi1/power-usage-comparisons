all: go quarkus nodejs pythondjango rails benchmarkcode pgsql kot rustaxum pythonjudev2 pythonjudev3 pythonjudev4 scalaio
...
pythonjudev4:
	docker build -t power/judev4 python/jude/v4/
